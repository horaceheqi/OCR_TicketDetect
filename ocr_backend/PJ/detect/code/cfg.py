...
patience = 5
load_weights = False        # 是否加载预训练模型
lambda_inside_score_loss = 4.0
lambda_side_vertex_code_loss = 1.0
lambda_side_vertex_coord_loss = 1.0

total_img = 10000       # train加val
validation_split_ratio = 0.1    # val占的总数比例
max_train_img_size = int(train_task_id[-3:])
max_predict_img_size = 1024  # int(train_task_id[-3:])  # 2400
# max_predict_img_size = 768  # int(train_task_id[-3:])  # 2400
...
data_dir = r'E:\dataset_private\ocr'
origin_image_dir_name = 'JPEG/'
...
saved_model_weights_file_path = 'model/east_model_weights_%s.h5'\
                                % train_task_id
# saved_model_weights_file_path = 'model/weights_3T736.004-0.392.h5'
pixel_threshold = 0.9
